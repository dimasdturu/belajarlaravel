            ...
            <div class="card card-primary">
              ...
              <form action="{{route('usersUpdate', $users->id)}}" method="post">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="password">Password <span class="text-danger">* isi password jika ingin mengganti</span></label>
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="alamat_lengkap" class="form-control" id="alamat_lengkap" 
                        ...
                        >{{(old('alamat_lengkap')) ? old('alamat_lengkap') : $users->alamat_lengkap}}</textarea>
                  </div>
                </div>
                <!-- /.card-body -->
