              ...
              <form action="{{route('produkStore')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="stok_produk" value="{{old('stok_produk')}}" 
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="berat_produk" value="{{old('berat_produk')}}" 
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="deskripsi_produk" class="form-control" id="deskripsi_produk" cols="30"
                        rows="5"
                        placeholder="Masukkan Deskripsi Produk">{{old('deskripsi_produk')}}</textarea>
                  </div>
